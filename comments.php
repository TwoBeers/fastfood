...
?>
	...
	<div class="comment_tools" id="comments" style="text-align: right;">
		<?php comments_number( __( 'No Comments' ), __( '1 Comment' ), __( '% Comments' ) ); ?> - <a href="#respond" title="<?php _e( "Leave a comment" ); ?>" onclick="return addComment.viewForm()" ><?php _e( "Leave a comment" ); ?></a>
	</div>
